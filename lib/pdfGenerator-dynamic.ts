...
export async function generateCertificate(data: {
  ...
  const ofPartWidth = timesRomanItalicFont.widthOfTextAtSize(ofPartText, ofPartFontSize);
  ...
  const nameWidth = timesRomanBoldFont.widthOfTextAtSize(fullName, nameFontSize);
  ...
  // Main certificate text using settings
  ...
  page.drawText(hodName, {
    x: width - 280 + (130 - timesRomanFont.widthOfTextAtSize(hodName, 10)) / 2,
    y: yPosition - 20,
    size: 10,
    font: timesRomanFont,
    color: black,
